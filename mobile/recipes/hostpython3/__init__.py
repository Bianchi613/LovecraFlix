# Receita travada na versão 3.11.5, igual à receita local de python3/ (mesma
# origem: commit af04bee3 do python-for-android). O p4a exige que python3 e
# hostpython3 sejam EXATAMENTE a mesma versão ("Build failed: python3 should
# have same version as hostpython3") — sem essa receita local, hostpython3
# ficava na versão padrão (3.14.2) enquanto python3 estava travado em 3.11.5,
# e o build falhava nessa checagem antes mesmo de compilar qualquer coisa.
