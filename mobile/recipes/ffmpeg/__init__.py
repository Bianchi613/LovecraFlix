# Receita travada na versão n4.3.1 (cópia da receita oficial do
# python-for-android no commit af04bee3, de 2024-06-02 — o momento exato em
# que o ffpyplayer foi fixado em v4.5.1). O ffpyplayer v4.5.1 foi compilado e
# testado contra esse FFmpeg; a receita oficial atual usa FFmpeg 8.0.1, que já
# removeu/alterou APIs (avfft.h, av_get_channel_layout_nb_channels,
# AVFrame.key_frame) que o código compilado do ffpyplayer ainda referencia —
# por isso o build quebra com FFmpeg novo.
