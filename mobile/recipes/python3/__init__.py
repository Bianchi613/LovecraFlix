# Receita travada na versão 3.11.5 (cópia da receita oficial do
# python-for-android no commit af04bee3, de 2024-06-02 — o momento exato em
# que o ffpyplayer foi fixado em v4.5.1). O código C gerado pelo Cython para o
# ffpyplayer foi escrito visando as APIs internas do CPython 3.11; a receita
# oficial atual usa Python 3.14.2, que renomeou/removeu funções internas
# (_PyGen_SetStopIterationValue, _PyList_Extend, _PyInterpreterState_GetConfig,
# _PyUnicode_FastCopyCharacters) — por isso o build quebra com Python novo.
